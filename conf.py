...
BLOG_AUTHOR = "Jiayi (Jason) Liu"  # (translatable)
BLOG_TITLE = "Lab of Random"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "https://jiayiliu.github.com/"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "https://jiayiliu.github.com/"
BLOG_EMAIL = "jiayi.uiuc@gmail.com"
BLOG_DESCRIPTION = "Records of random experiments"  # (translatable)
...
NAVIGATION_LINKS = {
    DEFAULT_LANG: (
        ...
        ("/categories/", "Tags"),
        ("/rss.xml", "RSS feed"),
        ("https://colab.research.google.com/github/jiayiliu/jiayiliu.github.io/blob/src/posts/index.ipynb", "Google Colab")
    ),
}
...
# is in the manual.
COMMENT_SYSTEM_ID = "321809675046639"
